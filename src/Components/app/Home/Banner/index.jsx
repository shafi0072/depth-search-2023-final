    ...
    return (
        <div>
            <div className='bg-image md:h-[75vh] lg:h-[90vh] w-full text-center flex flex-col items-center justify-center py-12 md:py-0'>
                ...
                <h2 className='uppercase text-4xl md:text-5xl lg:text-7xl font-bold'>Welcome to depth Search</h2>
                <p className=' text-xl md:text-3xl font-semibold my-6'>Unveiling Depths with Innovative Software Solutions!</p>
                <div className='mt-10'>
