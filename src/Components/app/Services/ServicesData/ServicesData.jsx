    ...
    <div className="max-w-7xl mx-auto">
      {services?.map((item, index) => (
        ...
        >
          ...
          <div
            className={` ms-5 py-10 w-full md:w-5/12 ${
          ...
          >
            ...
            <button
              ...
              className="uppercase  bg-primary px-6 py-4 rounded text-xl mr-4 my-5"
            >
              Free Consultation
            </button>
            <ul>
              {item?.services?.map((data, index) => (
                <li key={index} className="text-lg">
                  {" "}
                  <ForwardOutlinedIcon className="text-red-500" /> {data}{" "}
                </li>
              ))}{" "}
            </ul>
          </div>
