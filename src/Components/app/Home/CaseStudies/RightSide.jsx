...
const RightSide = ({caseStudy}) => {
    return (
        <div className=' px-4 lg:px-24'>
            ...
            <div className='mt-32 flex gap-8 md:gap-40 lg:gap-56'>
                <div>
                    <h1 className='text-6xl md:text-[200px] text-blue-500'>{caseStudy?.increase_in_overall}</h1>
                    <p className='md:ml-12 md:text-3xl'>Increase in overall traffic</p>
                </div>
                <div>
                    <h1 className='text-6xl md:text-[200px] text-blue-500 '>{caseStudy?.  faster_loading_speed}</h1>
