...
const LeftSide = ({setSelectedCase,selectedCase}) => {
    ...
    return (
        <div className='w-full h-full relative ps-3 lg:ps-0' style={{backgroundImage:`linear-gradient(rgba(0, 0, 0, 0.425) ,rgba(0, 0, 0,0.87)),url(https://i.ibb.co/KGjKzYK/male-female-graphic-designers-interacting-computer.jpg)`,backgroundPosition:"center center ", backgroundSize:"cover", backgroundRepeat:"no repeat"}}>
